...
<template>
  <PublicLayout>
    <PageHero compact eyebrow="Contact" title="Reach the WAAIS team." lede="Questions about membership, events, partnerships, or anything else — send us a message and we'll reply by email." />
