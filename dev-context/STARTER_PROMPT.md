...
Commit backend/composer.lock, then continue the backend API/auth foundation. Add Sanctum or the selected API auth package before implementing Google OAuth, membership application endpoints, admin review flows, or database-backed workflows.
```
