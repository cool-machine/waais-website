...
- `app-dashboard-admin-auth.html` — interactive auth, member dashboard, and admin dashboard prototype, including public-content management for events, startups, partners, and homepage cards.
- `assets/waais-hero-video.mp4` — local homepage hero video downloaded from George's licensed YouTube upload.

Current deployment:

- Public site root: `https://cool-machine.github.io/waais-website/`
- Public mockup direct link: `https://cool-machine.github.io/waais-website/mockups/public-site.html`
